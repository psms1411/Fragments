...
import com.py.ps.fragments.dummy.DummyContent;
...
public class FruitListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final FruitListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(FruitDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(FruitDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(FruitListActivity parent,
